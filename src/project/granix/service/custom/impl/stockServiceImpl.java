...
public class stockServiceImpl implements stockService{
    ...
    public String addStock(stockDto dto) throws Exception {
        stockEntity stockEntity = new stockEntity(dto.getStock_ID(), dto.getStock_name(), dto.getQuantity(), dto.getPPU_kg());
    ...
    public stockDto getStock(String id) throws Exception {
        ...
        return new stockDto(entity.getStock_ID(), entity.getStock_name(), entity.getQuantity(), entity.getPPU_kg());
    }
    ...
    public ArrayList<stockDto> getAllStock() throws Exception {
        ...
        for (stockEntity entity : stockEntitys) {
            stockDto dto = new stockDto(entity.getStock_ID(), entity.getStock_name(), entity.getQuantity(), entity.getPPU_kg());
            stockDtos.add(dto);
        }
        return stockDtos;
